...
import { saveIteration, listIterations, getIterationDetails, compareIterations, SelectedComponents, UserRequirements } from '../../src/tracker';
...
describe('Iteration Tracker', () => {
  ...
  test('should create .configurator folder and save iteration', async () => {
  ...
  test('should list saved iterations', async () => {
  ...
  test('should get iteration details', async () => {
    const selectedComponents: SelectedComponents = {
      agents: ['test-agent-1', 'test-agent-2'],
      commands: ['test-command-1'],
      hooks: [],
