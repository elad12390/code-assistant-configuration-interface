...
describe('Requirement Collector', () => {
  test('should have required questions defined', () => {
  ...
  test('should have project type question as required', () => {
  ...
  test('should have programming languages question', () => {
    const programmingLanguagesQuestion = PROJECT_REQUIREMENTS_QUESTIONS.find(q => q.id === 'programming-languages');
